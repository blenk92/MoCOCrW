...
protected:
    ...
    mococrw::AsymmetricKeypair _eccKeyPairED448 = AsymmetricKeypair::generateECC();
    mococrw::AsymmetricKeypair _eccKeyPairED448_2 = AsymmetricKeypair::generateECC();
    mococrw::AsymmetricKeypair _eccKeyPairED25519 = AsymmetricKeypair::generateECC();
    mococrw::AsymmetricKeypair _eccKeyPairED25519_2 = AsymmetricKeypair::generateECC();
...
void KeyHandlingTests::SetUp() {
    ...
    _eccKeyPairED448 = AsymmetricKeypair::generate(mococrw::ECCSpec{openssl::ellipticCurveNid::ED448});
    _eccKeyPairED448_2 = AsymmetricKeypair::generate(mococrw::ECCSpec{openssl::ellipticCurveNid::ED448});

    _eccKeyPairED25519 = AsymmetricKeypair::generate(mococrw::ECCSpec{openssl::ellipticCurveNid::ED25519});
    _eccKeyPairED25519_2 = AsymmetricKeypair::generate(mococrw::ECCSpec{openssl::ellipticCurveNid::ED25519});
}
...
TEST_F(KeyHandlingTests, testGeneratedKeyIsNotNull)
{
    ...
    ASSERT_THAT(_eccKeyPairED448.internal(), NotNull());
    ASSERT_THAT(_eccKeyPairED25519.internal(), NotNull());
}
...
TEST_F(KeyHandlingTests, testPublicKeyPemIsReproducible)
{
    ...
    const auto pemOfED448Key = _eccKeyPairED448.publicKeyToPem();
    const auto pemOfED448Key2 = _eccKeyPairED448.publicKeyToPem();

    const auto pemOfED25519Key = _eccKeyPairED25519.publicKeyToPem();
    const auto pemOfED25519Key2 = _eccKeyPairED25519.publicKeyToPem();
...
TEST_F(KeyHandlingTests, testPubKeyFromSavedPemIsSameAsOriginalInOpenSSLObject)
{
    ...
    ASSERT_EQ(_eccKeyPairED448, ED448ParsedKey);
    ASSERT_EQ(_eccKeyPairED25519, ED25519ParsedKey);
...
TEST_F(KeyHandlingTests, testPrivKeyFromSavedPemIsSameAsOriginal)
{
    ...
    const auto pemOfSectED448PubKey = _eccKeyPairED448.publicKeyToPem();
    const auto pemOfSectED448PrivateKey = _eccKeyPairED448.privateKeyToPem("f00");
    ...
    const auto pemOfSectED25519PubKey = _eccKeyPairED25519.publicKeyToPem();
    const auto pemOfSectED25519PrivateKey = _eccKeyPairED25519.privateKeyToPem("bar");
...
TEST_F(KeyHandlingTests, testBothGeneratedKeysNotTheSame)
{
    ...
    ASSERT_NE(_eccKeyPairED448, _eccKeyPairED448_2);

    ASSERT_NE(_eccKeyPairED25519, _eccKeyPairED25519_2);
}
...
TEST_F(KeyHandlingTests, testThrowsWhenReadingPrivateKeyUsingWrongKey)
{
    ...
    const auto pemOfED448PrivateKey = _eccKeyPairED448.privateKeyToPem("secret");
    ASSERT_THROW(AsymmetricKeypair::readPrivateKeyFromPEM(pemOfED448PrivateKey, "santa"),
                 mococrw::OpenSSLException);

    const auto pemOfED25519PrivateKey = _eccKeyPairED25519.privateKeyToPem("secret");
...
TEST_F(KeyHandlingTests, testKeyTypeChecking)
{
    ...
    EXPECT_EQ(_eccKeyPairED448.getType(), AsymmetricKey::KeyTypes::ECC);
    EXPECT_EQ(_eccKeyPairED25519.getType(), AsymmetricKey::KeyTypes::ECC);
}
...
TEST_F(KeyHandlingTests, testGetKeySpec)
{
    ...
    auto ED448Spec = _eccKeyPairED448.getKeySpec();
    auto ED25519Spec = _eccKeyPairED25519.getKeySpec();
...
TEST_F(KeyHandlingTests, testGetSize)
{
    ...
    EXPECT_EQ(_eccKeyPairED448.getKeySize(), 456);
    EXPECT_EQ(_eccKeyPairED25519.getKeySize(), 253);
